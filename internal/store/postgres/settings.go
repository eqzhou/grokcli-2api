...
func (c *Connector) PublicSettings(ctx context.Context) (map[string]any, error) {
	...
	out := map[string]any{
		...
		"history_compact_enabled":       boolSetting(values, "history_compact_enabled", true),
		"history_compact_auto_chars":    intSetting(values, "history_compact_auto_chars", 600_000),
		"history_keep_tool_rounds":      intSetting(values, "history_keep_tool_rounds", 8),
		"history_max_tool_result_chars": intSetting(values, "history_max_tool_result_chars", 16_000),
		...
		"model_health_auto_recover":     boolSetting(values, "model_health_auto_recover", false),
		...
		"model_health_recovery_batch":   floatSetting(values, "model_health_recovery_batch", 10),
		"model_health_recovery_workers": floatSetting(values, "model_health_recovery_workers", 2),
...
func (c *Connector) UpdateRuntimeSettings(ctx context.Context, patch map[string]any) (map[string]any, error) {
	...
	specs := []fieldSpec{
		...
		{key: "model_health_auto_recover", kind: "bool"},
		{key: "model_health_probe_batch", kind: "float", minF: 1, maxF: 1000},
		{key: "model_health_probe_workers", kind: "float", minF: 1, maxF: 64},
		{key: "model_health_recovery_batch", kind: "float", minF: 1, maxF: 100},
		{key: "model_health_recovery_workers", kind: "float", minF: 1, maxF: 8},
...
func defaultPoolPolicy() map[string]any {
	return map[string]any{
		...
		"soft_model_block_ttl_sec":    float64(900),
